...
import { RightIcon } from 'components/Assets';
...
export const DisplayOption: React.FC<DisplayOptionProps> = ({
    ...
    if (typeof option === 'function') return <li onClick={() => (setOutsideEscape(false), toggle())}> <Option /> </li>;
...
export const OptionsInput: React.FC<OptionsInputProp> = (
    { label, onChange, value, placeHolder, className, field, onClick = () => null, errorClass = "-", cssProps, ...props }
) => {
...

                    {
                        !props.isContextMenu ?
                            ...
                            <>
                                ...
                                <i dangerouslySetInnerHTML={{ __html : RightIcon }} />
                            </>
